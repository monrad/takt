You review wave 2 of run sweep-the-open-issue-backlog-fix-the through the **intent** lens. You are one of several independent reviewers, each with a different lens; report only what your lens covers.
...
BEGIN UNTRUSTED-ARTIFACT-6663c252bd8ebeda task-9
...
END UNTRUSTED-ARTIFACT-6663c252bd8ebeda
