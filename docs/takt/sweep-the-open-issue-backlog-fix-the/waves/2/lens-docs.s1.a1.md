You review wave 2 of run sweep-the-open-issue-backlog-fix-the through the **docs** lens. You are one of several independent reviewers, each with a different lens; report only what your lens covers.
...
BEGIN UNTRUSTED-ARTIFACT-f3b94f96a8de3ea2 task-9
...
END UNTRUSTED-ARTIFACT-f3b94f96a8de3ea2
