You are implementing task 9 of 14 for run sweep-the-open-issue-backlog-fix-the. Your cwd is the repository root; every path is relative to it.
...
BEGIN UNTRUSTED-ARTIFACT-98506ae2a9b4acd0 task-title
Publish the push_pr command: the two skill rows, design §7.5, and the absolute-path invariant
END UNTRUSTED-ARTIFACT-98506ae2a9b4acd0

BEGIN UNTRUSTED-ARTIFACT-98506ae2a9b4acd0 task-description
...
BEGIN UNTRUSTED-ARTIFACT-98506ae2a9b4acd0 spec-excerpt
