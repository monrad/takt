You are implementing task 5 of 14 for run sweep-the-open-issue-backlog-fix-the. Your cwd is the repository root; every path is relative to it.
...
BEGIN UNTRUSTED-ARTIFACT-f3367f589e434e08 previous-failure
blocked: internal/cli/cmd_record_test.go:273 needs `"citations":["a.go:1"]` → `"citations":["README.md:1"]` (or `[]`); that file is not in my declared list.
END UNTRUSTED-ARTIFACT-f3367f589e434e08
...
BEGIN UNTRUSTED-ARTIFACT-f3367f589e434e08 task-title
goal-assessor citations are validated as path:line inside a real file in the repository
END UNTRUSTED-ARTIFACT-f3367f589e434e08

BEGIN UNTRUSTED-ARTIFACT-f3367f589e434e08 task-description
...
BEGIN UNTRUSTED-ARTIFACT-f3367f589e434e08 spec-excerpt
