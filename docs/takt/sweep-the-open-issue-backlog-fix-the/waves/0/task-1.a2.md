You are implementing task 1 of 14 for run sweep-the-open-issue-backlog-fix-the. Your cwd is the repository root; every path is relative to it.
...
BEGIN UNTRUSTED-ARTIFACT-4b2e880231b8c2d7 previous-failure
failed: verify — go test -race -count=1 ./internal/gate/... ./internal/cli/... exited 1: --- FAIL: TestRecordGoalsReportsALostStreakResetAppend (0.02s)
    cmd_record_test.go:417: the loss must be reported under "warnings": map[problems:[G1: citation "a.go:1" — not a file] valid:false]
FAIL
FAIL	github.com/monrad/takt/internal/cli	6.622s
FAIL
END UNTRUSTED-ARTIFACT-4b2e880231b8c2d7
...
BEGIN UNTRUSTED-ARTIFACT-4b2e880231b8c2d7 task-title
follow-ups.json: wave as *int, an injective identity with idempotent append, single-write findings files
END UNTRUSTED-ARTIFACT-4b2e880231b8c2d7

BEGIN UNTRUSTED-ARTIFACT-4b2e880231b8c2d7 task-description
...
BEGIN UNTRUSTED-ARTIFACT-4b2e880231b8c2d7 spec-excerpt
