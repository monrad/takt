You are implementing task 2 of 4 for run parsereport-in-internal-cli-cmd-record-go-reads. Your cwd is the repository root; every path is relative to it.
...
BEGIN UNTRUSTED-ARTIFACT-9215fd80b4c018e8 spec-excerpt
