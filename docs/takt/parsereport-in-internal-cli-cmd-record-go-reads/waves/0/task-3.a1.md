You are implementing task 3 of 4 for run parsereport-in-internal-cli-cmd-record-go-reads. Your cwd is the repository root; every path is relative to it.
...
- G4 — The implementer's report contract states the tolerance, and the generated Copilot agent stays in parity with it.
...
BEGIN UNTRUSTED-ARTIFACT-c8a16c1140945baa spec-excerpt
