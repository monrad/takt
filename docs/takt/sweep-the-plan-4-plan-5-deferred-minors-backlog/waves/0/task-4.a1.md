You are implementing task 4 of 9 for run sweep-the-plan-4-plan-5-deferred-minors-backlog. Your cwd is the repository root; every path is relative to it.
...
BEGIN UNTRUSTED-ARTIFACT-b92cd6b20c3f1c55 task-title
The planner brief quotes its rejections inside the delimiter pair
END UNTRUSTED-ARTIFACT-b92cd6b20c3f1c55

BEGIN UNTRUSTED-ARTIFACT-b92cd6b20c3f1c55 task-description
...
- G8 — The planner brief renders its rejected-attempt problems inside the delimiter quote, matching the other three templates.
...
BEGIN UNTRUSTED-ARTIFACT-b92cd6b20c3f1c55 spec-excerpt
